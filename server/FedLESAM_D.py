...
class FedLESAM_D(Server):
    def __init__(self, device, model_func, init_model, init_par_list, datasets, method, args):   
        super(FedLESAM_D, self).__init__(device, model_func, init_model, init_par_list, datasets, method, args)
    ...
    def global_update(self, selected_clients, Averaged_update, Averaged_model):
        ...
        self.comm_vecs['global_update']=(Averaged_update+torch.mean(self.h_params_list, dim=0)).clone().detach()
